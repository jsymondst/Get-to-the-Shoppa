...
import { Button, Image, List, Icon, Input } from "semantic-ui-react";
            ...
            >
                <List divided verticalAlign="middle">
                    <List.Item>
                        <List.Content floated="right">
                            <Button.Group compact size="mini">
                                ...
                                <Button
                                    ...
                                    content="Teal"
                                    onClick={() =>
                                        itemMethods.checkItem(fullListIndex)
                                    }
                                    // onClick={() => this.checkItem(id)}
                                >
                                    <Icon name="check" />
                                ...
                                <Button
                                    ...
                                    content="Red"
                                    onClick={() =>
                                        itemMethods.deleteItem(fullListIndex)
                                    }
                                >
                                    <Icon name="delete" />
                                </Button>
                        ...
                        <Icon color="" name="shopping basket"></Icon>
                        <List.Content>
                            {editable ? (
                                <Input
                                    style={{ width: "9em", height: "12px" }}
                                    size="small"
                                    type="text"
                                    value={name}
